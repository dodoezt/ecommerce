...
const ProductSearched = () => {
    ...
    return (
        <div className='w-full flex flex-col justify-center items-end px-5 xl:mt-24 mt-20'>
            ...
            <main className="w-full flex flex-col justify-start items-start">
                <div className="w-auto grid xl:grid-cols-7 md:grid-cols-4 grid-cols-2 gap-7">
                    {product.slice(0, visibleCount).map((product) => {
                        return (
                        <Link to={`/product/${product.id}`} key={product.id} className="xl:w-44 md:w-44 w-40 aspect-[3/5] flex flex-col justify-start items-center rounded-xl shadow-[rgba(255, 255, 255, 0.24) 0px 3px 8px;] bg-[#212121] overflow-hidden gap-1">
